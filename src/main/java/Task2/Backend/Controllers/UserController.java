...
public class UserController {
    ...
    public record User(long id, String name, String lastName, String patronymic, int group) {};
    ...
    public void addUser(@RequestBody String userJson) throws SQLException {
        ...
        String sql = " INSERT INTO users(user_name, last_name, patronymic, group_num)\n" +
                " VALUES (?, ?, ?, ?);";
    ...
    public List<User> getAllUsers() throws SQLException {
        ...
        while (result.next()) {
            ...
            users.add(new User(id, userName, lastName, patronymic, group));
        }
